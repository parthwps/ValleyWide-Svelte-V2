        ...
        {#if index < propCount}
            <div class="masonry-items" in:fly="{{ y: 0, duration: 1000, delay:index * 1500}}" out:fly="{{y:0, duration:1000 }}"> 
                <a data-sveltekit-reload href="/portfolio/{project.attributes.slug}" class="zoomImg">  
                    ...
                    <ImageLoader src="https://api.valleywidebuilders.com/{project.attributes.featuredImage.data.attributes.url}" lowRes="https://api.valleywidebuilders.com/{project.attributes.featuredImage.data.attributes.formats.small.url}" alt="{project.attributes.title}"></ImageLoader>
