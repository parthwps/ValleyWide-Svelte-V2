...
<Col md="3">
  <div class="slider-caption">
    <div class="slider-caption__heading">
      ...
      <h2 class="text-animate primary-font stc" in:textAnimate id="carousel-heading">{heading ? heading : ''}</h2>
    </div>
...
<a href="/portfolio/{project.attributes.slug ? project.attributes.slug : '#'}" data-sveltekit-reload class="zoomImg" draggable="false">
  ...
  <div class="slider-container__carousel-cell__text">
    ...
    <i><svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.29004 12.3459L6.29004 6.84595L1.29004 1.34595" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/></svg></i>
  </div>
</a>  
</div>
...
.left-right img{
  height: 30px;
  filter: invert(32%) sepia(43%) saturate(366%) hue-rotate(333deg) brightness(92%) contrast(87%);
}
