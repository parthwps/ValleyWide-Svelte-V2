...
<section class="our_client_say">
	<h2 class="text-animate primary-font" in:textAnimate id="testimonial-heading" gsap-duration="1">
		...
		<div class="embla__container">
			{#each clientTestimonials as testimonial}
				<div class="slider embla__slide">
					...
					<h3 class="primary-font stc">{testimonial.attributes.Name ? testimonial.attributes.Name : ''}</h3>
				</div>
			{/each}
		</div>
