										...
										{#each portfolioList as project, index}				
											...
											<div class="masonry-items" in:fly id="masonry-items{index}" gsap-duration="1" gsap-delay={index/2} gsap-y="30" gsap-start="top 90%"> 
												...
												<a data-sveltekit-reload href="/portfolio/{project.attributes.slug}" class="zoomImg">      
													...
													<img loading="lazy" src="https://vwapi.netdevs.net/{project.attributes.featuredImage.data.attributes.formats.large.url ? project.attributes.featuredImage.data.attributes.formats.large.url : project.attributes.featuredImage.data.attributes.url}" alt="{project.attributes.title}" >   
													{:else}
